...
describe('Bookmarks Endpoints', () => {
  ...
  describe('Unauthorized requests', () => {
    it('responds with 401 Unauthorized for GET /bookmarks', () => supertest(app)
      .get('/bookmarks')
      .expect(401, { error: 'Unauthorized request' }));

    it('responds with 401 Unauthorized for POST /bookmarks', () => supertest(app)
      .post('/bookmarks')
  ...
  describe('GET /bookmarks', () => {
    ...
    context('Given there are bookmarks in the database', () => {
      ...
      beforeEach('insert bookmarks', () => db
        .into('bookmarks')
        .insert(testBookmarks));

      it('gets the bookmarks from the store', () => supertest(app)
        .get('/bookmarks')
        .set('Authorization', `Bearer ${process.env.API_TOKEN}`)
  ...
  describe('GET /bookmarks/:id', () => {
    context('Given no bookmarks', () => {
      it('responds 404 whe bookmark doesn\'t exist', () => supertest(app)
        .get('/bookmarks/123')
        .set('Authorization', `Bearer ${process.env.API_TOKEN}`)
        .expect(404, {
  ...
  describe('DELETE /bookmarks/:id', () => {
    ...
    it('returns 404 whe bookmark doesn\'t exist', () => supertest(app)
