...
describe('Bookmarks Endpoints', () => {
  ...
  describe('Unauthorized requests', () => {
    ...
    it('responds with 401 Unauthorized for GET /api/bookmarks', () => supertest(app)
      .get('/api/bookmarks')
      .expect(401, { error: 'Unauthorized request' }));

    it('responds with 401 Unauthorized for POST /api/bookmarks', () => supertest(app)
      .post('/api/bookmarks')
  ...
  describe('GET /api/bookmarks', () => {
    ...
    context('Given an XSS attack bookmark', () => {
      ...
      beforeEach('insert malicious bookmark', () => db
        .into('bookmarks')
